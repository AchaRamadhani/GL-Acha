...
$laundryRows = [
    ...
    ['no' => 6, 'nota' => 'INV-250520-013', 'name' => 'Ahmad Fauzi', 'phone' => '0811-5566-7788', 'service' => 'Baju Bayi', 'weight' => '2,5 kg', 'in' => '20 Mei 2026', 'eta' => '21 Mei 2026', 'status' => 'Dicuci', 'tone' => 'blue', 'total' => 'Rp 50.000'],
    ...
    <div class="dashboard-content">
        ...
        <main class="dashboard-main laundry-main">
            ...
            <div class="laundry-note">
                ...
                <p><strong>Catatan:</strong> Halaman ini untuk pengelolaan data cucian (CRUD). Update status cucian dilakukan melalui menu <a href="<?= $safeBaseUrl ?>/admin">Update Status</a>.</p>
            </div>
